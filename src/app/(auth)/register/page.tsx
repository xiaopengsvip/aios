      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center bg-gray-50 dark:bg-background">
        ...
        <div className="relative text-center px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <img src="/icons/icon-192.png" alt="AIOS" className="w-16 h-16 rounded-2xl mx-auto mb-8 shadow-xl shadow-purple-500/20 object-cover" />
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-[400px]">
          <div className="lg:hidden flex items-center gap-3 mb-10">
            <img src="/icons/icon-192.png" alt="AIOS" className="w-10 h-10 rounded-xl shadow-lg shadow-purple-500/20 object-cover" />
